...
const defaultAbbreviations = ['abr','apr','aug','al','ave','cir','ct','dec','dr','ed','etc','feb','gen','inc','jan','jr','jul','jun','ln','mar','mr','mrs','nov','oct','prof','rep','rd','rev','sen','sep','sr','st','v','vol','vs'];
