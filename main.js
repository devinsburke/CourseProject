...
function extractPageSummary(settings, escrape) {
	...
	if (settings.suppress_landing.value && stopUrls.includes(document.location.pathname.toLowerCase()))
		return {
			success: false,
			message: 'Tilder is configured to ignore landing pages and search pages, as they are generally bad candidates for summarization. You may change this in the extension Options.',
		}
